...
import com.example.kalpataru.databinding.ItemDashBinding
import com.example.kalpataru.model.Article
import dagger.hilt.android.qualifiers.ActivityContext
import javax.inject.Inject

class NewsAdapter @Inject constructor(@ActivityContext private val context : Context): RecyclerView.Adapter<NewsAdapter.MyViewHolder>()
{
    private lateinit var binding : ItemDashBinding
    ...
    {
        binding = ItemDashBinding.inflate(LayoutInflater.from(context),parent,false)
        return MyViewHolder()
    }
